...
const signs=[...new Map(raw.split('\n').map(line=>{const [id,name,category,extra]=line.split('|');return[id,{id,name,category,extra:extra==='1',svg:`https://sevas.nrw.de/vz/${id}.svg`,quiz:verifiedQuizIds.has(id)}]})).values()];
